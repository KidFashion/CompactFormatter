...
// Type: CompactFormatter.SystemUri_Overrider
...
{
  [Overrider(typeof (Uri))]
  internal class SystemUri_Overrider : IOverrider
  {
    ...
    public object Deserialize(CompactFormatter parent, Stream serializationStream)
    {
      ...
      return (object) new Uri(PrimitiveSerializer.DeserializeString(serializationStream));
    }
  }
}
